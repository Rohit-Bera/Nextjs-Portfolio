...
import articleImg2 from "../../public/images/articles/create loading screen in react js.jpg";
  ...
  return (
    <li className="relative col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:border-light dark:bg-dark ">
      ...
      <Link
        href={link}
        target="_blank"
        // to hover imgae use inline-block overflow-hidden
...
const Article = ({ img, title, date, link }) => {
  return (
    <motion.li
      ...
      viewport={{ once: true }}
      className="relative w-full p-4 py-6 px-4 my-4 rounded-xl flex items-center justify-between bg-light 
    ...
    >
      ...
      <span className="text-primary font-semibold pl-4 sm:self-start  sm:pl-0 sm:tetx-sm ">
        {date}
      </span>
    </motion.li>
  );
...
const articles = () => {
  return (
    <>
      <Head>
        <title>Rohit Bera | Articles</title>
