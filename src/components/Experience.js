...
const Details = ({ position, company, comLink, time, address, work }) => {
    ...
    >
      ...
      >
        <h3 className="capitalize font-bold text-2xl dark:text-light sm:text-xl xs:text-lg ">
          {position}&nbsp;{" "}
          <a href={comLink} target="_blank" className="text-primary capitalize">
            {company}
          </a>
        </h3>
    ...
    <div className="my-60">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full ">
        ...
        <motion.div
          ...
          className="absolute left-9 top-0 w-[4px] h-full bg-dark origin-top dark:bg-light md:w-[3px] md:left-[30px] xs:left-[20px] "
        />
        <ul className="w-full flex flex-col items-start justify-between ml-4 xs:ml-2 ">
          <Details
            position="Software Engineer"
            company="@Google"
            comLink="www.google.com"
            time="2022-Present"
